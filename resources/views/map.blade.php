...
#Result{border:3px solid #40AA53;margin:0 auto;text-align:center;width:400px;padding:150px 0;background:#efe;}
...
#map{border:3px solid #40AA53;margin:0 auto;text-align:center;width:400px;padding:150px 0;background:#efe;}
</style>
@endsection
